...
#practice exc in class: 

```

            myvars <- c(totalpop = "B01003_001",
            total_foster_child = "B09019_024", 
            total_highschool_graduate = "B07009_003")
...
allcounties_wide <- allcounties_wide %>%
  mutate(
    pct_total_highschoolgraduate = round_half_up(total_highschool_graduate /   total_foster_childe * 100, 2)
    ...
    myvars <- c(totalpop = "B01003_001",
            total_foster_child = "B09018_008",
           less_highschool = "B06009PR_002",
            total_highschool_graduate = "B06009PR_003")
            allcounties_wide <- get_acs(geography = "county",
                         variables = c(myvars),
                         output = "wide",
                         geometry = TRUE)
